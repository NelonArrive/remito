...
export const heroSlides: HeroSlideData[] = [
  {
    ...
    title: <>Ремонт оргтехники<br /> <em>любой сложности</em></>,
    desc: 'Canon, HP, Xerox, Samsung, Epson — ремонтируем любые модели. Диагностика бесплатно. Выезд в удобное время.',
    btnPrimary: { label: 'Вызвать мастера', icon: <PhoneIcon /> },
    btnOutline: { label: 'Узнать стоимость →', href: '/uslugi/remont-printerov/' },
    stats: [
      { num: '2 000+', label: 'Ремонтов в год' },
      { num: 'Бесплатно', label: 'Диагностика' },
      { num: 'Гарантия', label: 'На все работы' },
    ],
    card: {
      floatTL: { icon: '🖨️', iconBg: '#EEF4FF', title: 'Принтер HP LaserJet', sub: 'Диагностика завершена' },
      floatBR: { icon: '✅', iconBg: '#DCFCE7', title: 'Гарантия на работы', sub: 'Ответственность за результат' },
      icon: <PrinterIcon />,
  ...
  },
  {
    ...
    title: <>Заправка<br />картриджей<br /></>,
    ...
    btnOutline: { label: 'Все картриджи →', href: '/uslugi/zapravka-kartridzhey/' },
    stats: [
