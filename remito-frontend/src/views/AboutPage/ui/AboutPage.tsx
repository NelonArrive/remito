...
import { IconMail, IconPhone, IconTg } from '@/shared/ui/Icons'
...
const TIMELINE = [
	...
	{ year: '2020', text: 'Запустили выездной сервис — работаем без выходных.' },
	{ year: '2022', text: 'Перешли на официальные запчасти OEM/ORI, ввели гарантию на все виды работ.' },
				...
				<div className={s.heroInner}>
					<div className={s.heroLeft}>
						...
						<p className={s.heroDesc}>
							С 2016 года помогаем частным клиентам и организациям решать проблемы с оргтехникой. Работаем честно,
					...
					<div className={s.storyInner}>
						<div className={s.storyLeft}>
							...
							<div className={s.storyText}>
								...
								<p>
									Сегодня мы выезжаем в удобное для клиента время и стараемся решить проблему с
